...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "Ariyan": "উনি এখন মেয়ে নিয়ে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!🫩🙏",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Rahat Islam☜\nFacebook: https://www.facebook.com/share/17D7Ftj1ri/",
    "admin": "He is Ariyan ahmed🥶🫢 আইডি বায়োতে আছে 🙂",
    ...
    "tor nam ki": "MY NAME IS  🔰Ariyan_𝗕𝗼𝘁🔰",
    "pic de": "এন থেকে সর দুরে গিয়া মর😒",
    "cudi": "এত চোদা চুদি করস কেনো..!🥱🌝🌚",
    "bal": "বেশি বড়ো হলে কেটে ফেল🫩🫩🙏",
 "শালা আমি আরিয়ান": "ভুল হয়ছে বস😩মাফ করে দাও🙏💩",
 "আমি আরিয়ান": "আরে বস😮 তুমি এই গ্রুপে কী করো",
 "Ariyan ka chudi": "তোর তো নুনুই নাই 🐸😂 চু*বি কীভাবে 💩",
 "Ariyan abal": "তোর বাপ আবাল 💩🫦",
 ...
 "শালা চুপ কর": "ওকে রাহাদ বস😗",
    ...
    শালা আমি আরিয়ান:ভুল হয়েগেছে বস মাফ করে দেন
  };
